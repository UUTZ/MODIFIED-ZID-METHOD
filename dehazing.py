...
from net.losses import AngularLossLayer
...
class Dehaze(object):
    ...
    def finalize(self):
        ...
        save_image(self.image_name + "_t_map", torch_to_np(self.mask_out), self.output_path)
        save_image(self.image_name + "_ambient", torch_to_np(self.ambient_out), self.output_path)
